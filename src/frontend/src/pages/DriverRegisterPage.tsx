                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      border: `2px solid ${s.done ? "#22C55E" : "#e2e8f0"}`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "1rem",
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(22,101,52,0.07) 0%, transparent 70%)",
          top: "-5%",
          left: "-10%",
          pointerEvents: "none",
        }}
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(22,101,52,0.05) 0%, transparent 70%)",
          top: "10%",
          right: "-8%",
          pointerEvents: "none",
        }}
      ...
      >
        ...
        >
          {BENEFITS.map((b, i) => {
            const colors = ["#22C55E", "#16A34A", "#22C55E", "#22c55e"];
            return (
              <div
                key={b.title}
                style={{
              ...
              <button
                ...
                style={{
                  ...
                  background: form.profilePhoto
                    ? "rgba(66,165,245,0.1)"
                    : "rgba(255,255,255,0.7)",
                  border: `2px dashed ${form.profilePhoto ? "#16A34A" : "#cbd5e1"}`,
                  borderRadius: 12,
                  padding: "1.25rem",
                  cursor: "pointer",
                  color: form.profilePhoto ? "#22C55E" : "#64748b",
                  fontFamily: "'Poppins',sans-serif",
                  fontSize: "0.875rem",
                  textAlign: "center",
                  minHeight: 64,
